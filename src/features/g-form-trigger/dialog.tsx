        ...
        <Dialog open = {open}  onOpenChange={onOpenChange}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Use this Webhook URL in your <b>Google Form's</b> Apps Script to trigger this workflow whenever a form is submitted.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                    ...
                    <div className="rounded-lg bg-muted p-4 space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                            This script includes your <b>Webhook URL</b> and handles form submissions
                        </p>
